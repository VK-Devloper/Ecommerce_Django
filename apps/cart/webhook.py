...
def webhook(request):
    ...
    if event.type == 'payment_intent.succeeded':
        ...
        # send_mail('Order confirmation', 'Your order is successful!', 'noreply@saulgadgets.com', ['vaibhavkotadiya27199@gmail.com', order.email], fail_silently=False, html_message=html)
